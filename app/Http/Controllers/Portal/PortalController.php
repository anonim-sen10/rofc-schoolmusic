    ...
    private function roleConfig(string $role): array
    {
        $map = [
            ...
            'admin' => [
                ...
                'stats' => [
                    ['label' => 'Active Classes', 'value' => MusicClass::query()->where('status', 'active')->count(), 'icon' => 'book-open'],
                    ['label' => 'Teachers', 'value' => Teacher::query()->where('is_active', true)->count(), 'icon' => 'music-2'],
                    ['label' => 'Students', 'value' => Student::query()->where('is_active', true)->count(), 'icon' => 'graduation-cap'],
                    ['label' => 'Pending Registrations', 'value' => Registration::query()->where('status', 'pending')->count(), 'icon' => 'clipboard-clock'],
                ],
                'modules' => [
